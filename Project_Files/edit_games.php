...
<?php
              ...
              /*  $query = "SELECT * FROM game g, product p WHERE g.product_id = p.product_id";  
                ...
                {  
                     ...
                     {  */ 
				   $sql = mysql_query("SELECT * FROM game g, product p WHERE g.product_id = p.product_id ORDER BY game_id DESC"); 
$total = mysql_num_rows($sql);

$adjacents = 3;
$targetpage = "edit_games.php"; //your file name
...
$sql2 = "SELECT * FROM game g, product p WHERE g.product_id = p.product_id ORDER BY game_id DESC";
	...
	?>
			...
			<div class="article">
              ...
              <h4 style="text-align:center;"><?php echo $row["game_name"]; ?></h4>
               <br>
			   <p align="center"><?php echo "<a class='btn btn-warning'   href = 'game_edit.php?Delete=$row[game_id]'>Edit</a>" ;?>
