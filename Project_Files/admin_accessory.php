	...
	?>
			...
			<div class="article">
              ...
              <h4 style="text-align:center;"><?php echo $row["accessory_name"]; ?></h4>
               <br><p align="center"><?php echo "<a class='btn btn-danger' onclick='return checkDelete()' href = 'delete_accessory.php?Delete=$row[product_id]'>Delete</a>" ;?>     
            </div>
			 <?php  
                     }  
                } 
...
echo '<br>';
echo '<br>';
echo '<h1 style="text-align:center"> Accessories will be availabe soon  </h1>';
