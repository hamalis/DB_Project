...
if (isset($_GET['Delete']))
{
	...
	$que =  " DELETE FROM `product`  WHERE product_id = '$id'";
		$que2 =  " DELETE FROM `accessory`  WHERE product_id = '$id'";
		$que3 =  " DELETE FROM `product`  WHERE product_id = '$id'";
...
//echo $record;
echo "<meta http-equiv='refresh' content = '0;url=admin_accessory.php'>"; 
