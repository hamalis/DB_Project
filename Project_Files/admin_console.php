...
$adjacents = 3;
$targetpage = "admin_console.php"; //your file name
...
$pagination.= "</ul></div>\n"; 
	...
	?>
			...
			<div class="article">
              ...
              <h4 style="text-align:center;"><?php echo $row["console_type"]; ?></h4>
              <br> <p align="center"><?php echo "<a class='btn btn-danger' onclick='return checkDelete()' href = 'delete_console.php?Delete=$row[product_id]'>Delete</a>" ;?>     
            </div>
			 <?php  
                     }  
