<?php        
			header( "refresh:5;url=http://localhost/game_portal/index.php" );
?> 
...
<div id="page" class="shell">
  ...
  <div id="main">
    <div id="main-bot">
	  ...
	  <div>
	  	<p align="center"><h1>Your account has been created.</h1></p> </br>
	   <h4> Thank you for registering with us.</h4> 
	   <p>Your account has been created, and now you can use your email address and password created to log-in. 
	   You will be redirected back to the home page in 5 seconds. If not, click here! <a href="index.php">Home</a></p>
	  </div>
	  </br>
	  </br>
