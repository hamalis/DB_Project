...
if (isset($_GET['Delete']))
{
	...
	$que =  " DELETE FROM `product`  WHERE product_id = '$user'";
		$que2 =  " DELETE FROM `game`  WHERE product_id = '$user'";
		$que3 =  " DELETE FROM `product`  WHERE product_id = '$user'";
...
//echo $record;
echo "<meta http-equiv='refresh' content = '0;url=admin_games.php'>"; 
