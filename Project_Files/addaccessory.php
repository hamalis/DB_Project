...
<div id="page" class="shell">
  ...
  <div id="main">
	...
	<form action="php/addaccessories.php" method="post" class="form-horizontal" enctype="multipart/form-data">
  <fieldset>
    <p align="center"><legend>Add new accessory</legend>
    <div class="form-group">
      <label for="inputEmail" class="col-lg-2 control-label">Accessory Name</label>
      <div class="col-lg-10">
        <input name="Aname" type="text" class="form-control" id="inputEmail" placeholder="Accessory Name" required autocomplete="off">
      </div>
      </div>
  ...
  <p align="center"><button class="btn btn-warning">Add Accessory</button>
