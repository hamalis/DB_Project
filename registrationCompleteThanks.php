<?php       include('session.php');
			header( "refresh:5;url=http://localhost:8080/game_portal/index.html" );
?> 
  ...
  <div id="main">
    <div id="main-bot">
	  ...
	  <h1>Your account has been created.</h1>
	   ...
	   You will be redirected back to the home page in 5 seconds. If not, click here! <a href="index.php">Home</a></h4>
	  </div>
